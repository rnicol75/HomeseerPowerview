...
Function BuildDailyReport() As String
    ...
    sb.AppendLine("<h1>🏠 Daily Home Status Report</h1>")
    ...
    sb.AppendLine("<h2>☀️ Sun Information</h2>")
    ...
    ' Thermostats Section
    sb.AppendLine("<h2>🌡️ Climate Control Status</h2>")
    sb.AppendLine("<table>")
    ...
    If lowBatteryShades <> "" Then
        sb.AppendLine("<h2>🔋 Low Battery Alerts</h2>")
        sb.AppendLine("<div class='alert'>")
        sb.AppendLine("<strong>⚠️ The following shades have battery levels at or below 25%:</strong><br><br>")
        sb.AppendLine(lowBatteryShades)
        sb.AppendLine("</div>")
    Else
        sb.AppendLine("<h2>🔋 Battery Status</h2>")
        sb.AppendLine("<p style='color: green; font-weight: bold;'>✓ All shades have adequate battery levels (>25%)</p>")
    End If
                        ...
                        If childDev IsNot Nothing Then
                            ...
                            If childName.Contains("Battery") And Not childName.Contains("Status") Then
                                ...
                                If batteryLevel <= 25 And batteryLevel > 0 Then
                                    ...
                                    sb.AppendLine("• <strong>" & shadeName & "</strong> - Battery: " & batteryLevel.ToString("0") & "%<br>")
                                End If
                            End If
                        End If
                    Next
